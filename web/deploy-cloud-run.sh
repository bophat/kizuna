...
SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED="${SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED:-true}"
AFFILIATE_RETURN_WINDOW_DAYS="${AFFILIATE_RETURN_WINDOW_DAYS:-14}"
AFFILIATE_MIN_PAYOUT_USD="${AFFILIATE_MIN_PAYOUT_USD:-20.00}"
...
case "$SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED" in
  1|true|TRUE|True|yes|YES) SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED="True" ;;
  0|false|FALSE|False|no|NO) SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED="False" ;;
  *)
    echo "SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED must be True or False."
    exit 2
    ;;
esac
