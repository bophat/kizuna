...
SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED = os.environ.get(
    'SOURCE_IMPORT_PUBLIC_PAGE_FALLBACK_ENABLED',
    'true',
).lower() in ('1', 'true', 'yes')
SOURCE_IMPORT_PUBLIC_PAGE_MAX_BYTES = int(os.environ.get(
    'SOURCE_IMPORT_PUBLIC_PAGE_MAX_BYTES',
    str(4 * 1024 * 1024),
))
SOURCE_IMPORT_PUBLIC_PAGE_TIMEOUT_SECONDS = float(os.environ.get(
    'SOURCE_IMPORT_PUBLIC_PAGE_TIMEOUT_SECONDS',
    '15',
))
SOURCE_IMPORT_PUBLIC_PAGE_MAX_REDIRECTS = int(os.environ.get(
    'SOURCE_IMPORT_PUBLIC_PAGE_MAX_REDIRECTS',
    '3',
))
SOURCE_IMPORT_PUBLIC_PAGE_CACHE_SECONDS = int(os.environ.get(
...
AFFILIATE_RETURN_WINDOW_DAYS = int(os.environ.get('AFFILIATE_RETURN_WINDOW_DAYS', '14'))
AFFILIATE_MIN_PAYOUT_USD = os.environ.get('AFFILIATE_MIN_PAYOUT_USD', '20.00')
